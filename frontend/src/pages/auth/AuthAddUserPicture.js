        ...
        try {
            ...
            if (response.status === 201 || response.status === 200) {
                ...
                if (result.file_url) {
                    ...
                    const updatedUser = { ...currentUser, user: { ...currentUser.user, profile_picture: result.file_url } };
                        ...
                        <div className="dropzone-msg dz-message needsclick">
                            ...
                            {imageUrl && (
                                <div id="uploaded-image" style={{ marginTop: '20px' }}>
                                    <img id="uploaded-image-id" src={imageUrl} alt="Uploaded" style={{ maxWidth: '100%' }} />
                                </div>
                            )}
                        </div>
                    </div>
